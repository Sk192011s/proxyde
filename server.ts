...
// ===========================
// 1. SECURITY: ALLOWED DOMAINS
// ===========================
// ဒီ Domain တွေကိုပဲ ခွင့်ပြုမယ် (တခြားဟာလာထည့်ရင် Block မယ်)
...
app.get("/stream", async (c) => {
    ...
    try {
        ...
        newHeaders.set("Access-Control-Allow-Origin", "*"); // Allow all players
...
<body class="flex flex-col items-center justify-center min-h-screen p-4">
    ...
    <script>
        function generateLink() {
            ...
            // Optional: Client side validation check (just for UX)
